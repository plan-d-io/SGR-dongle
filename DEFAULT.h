...
{0x20,0,105,2,1,"Outdoor air temp.", "°C"},
...
{0x21,4,101,2,-1,"INV primary voltage", "V"}, //!
//{0x21,4,105,2,1,"INV fin temp.", "°C"},
...
{0x60,7,105,2,1,"R/C Setpoint", "°C"},
{0x60,9,105,2,1,"H/P Outlet Setpoint", "°C"},
...
{0x61,10,105,2,1,"DHW tank temperature", "°C"}, //! + COFY
{0x61,12,105,2,1,"Indoor ambient temperature", "°C"}, //! + COFY
...
{0x62,3,105,2,1,"LW setpoint", "°C"},
{0x62,5,105,2,1,"Room temperature setpoint", "°C"}, //! + COFY
};
